...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enable_bt.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (!isChecked) {
                    BA.disable();
                    Toast.makeText(MainActivity.this, "Convertidor desactivado", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intentOn = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
                    startActivityForResult(intentOn, 0);
                    Toast.makeText(MainActivity.this, "Convertidor activado", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        visible_bt.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ...
                    Toast.makeText(MainActivity.this, "Visible por 2 min", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void list(){
        ...
        Toast.makeText(this, "Mostrando dispositivo", Toast.LENGTH_SHORT).show();
